class HostelOperationController < ApplicationController
 def devise_index
        ...
        @role=@hosteler.role
            ...
            if @role=='student'
                if @hosteler.status
                    ...
                    redirect_to edit_hostel_operation_path(@hosteler.id)
                end 
            else
    ...
    def get_paramas
        params.require(:hosteler).permit(:firstname,:lastname,:email,:phoneno,:username,:password,:role,:status,:room_no)
    end
end
